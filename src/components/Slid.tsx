...
export const Slid = () => {
    ...
    return(
        <div className="relative">
            <div className="bg-red-500 h-80 bg-center bg-cover" style={{backgroundImage: `url(${itens[actual].url})`}}>
                <div onClick={Before} className="ml-1 text-4xl cursor-pointer font-bold text-white opacity-70 absolute left-0 top-[45%]">{'<'}</div>
                <div onClick={After} className="mr-1 text-4xl cursor-pointer font-bold text-white opacity-70 absolute right-0 top-[45%]">{'>'}</div>
                <div>
