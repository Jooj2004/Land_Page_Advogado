...
export const Slid = () => {
    ...
    return(
        <div className="relative">
            <div className="h-80 lg:h-96 bg-center bg-cover" style={{backgroundImage: `url(${itens[actual].url})`}}>
                ...
                <div>
                    <h1 className="text-white text-center lg:text-4xl text-2xl uppercase py-5">{itens[actual].title}</h1>
                    <p className="px-9 text-white text-sm lg:text-lg font-semibold">{itens[actual].body}</p>
                </div>
            </div>
